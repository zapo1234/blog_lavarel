            ...
            <div class="alert alert-success" role="alert">
                ...
                <form method="POST" action="{{ route('creates') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" name="nom" placeholder=""
                               required>
                        @if($errors->has('nom'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="formGroupExampleInput2" name="email" placeholder=""
                               required>
                    </div>
